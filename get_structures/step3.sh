...
printf '\tComparing oligomerization states:'; print_array "${compare_mer[0]}"
printf '\tResidue Range:'; print_array "${residue_range[0]}"

#cut pdbs according to alignment 
header trimming and cleaning pdbs
cp pdb_bank/aligned/*.pdb pdb_bank/cut_and_cleaned
